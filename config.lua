...
-- config.shell = true    -- Uncomment to disable shell / comment to enable shell
-- config.history = true  -- Uncomment to disable history / comment to enable history
...
config.logcons = true  -- Uncomment to disable syslog messages on the console
